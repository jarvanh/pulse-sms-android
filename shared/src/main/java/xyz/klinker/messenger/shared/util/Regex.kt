...
object Regex {
    ...
    private val URL_VALID_GTLD = "(?:(?:" +
            ...
            "gratis|green|gripe|guide|guitars|guru|hamburg|haus|health|hiphop|hiv|holdings|holiday|homes|horse|host|house|" +
            ...
            "moscow|motorcycles|museum|nagoya|name|navy|net|neustar|news|nhk|ninja|nyc|okinawa|onl|online|org|organic|ovh|page|paris|" +
