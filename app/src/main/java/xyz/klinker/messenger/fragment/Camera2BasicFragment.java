...
public class Camera2BasicFragment extends Fragment
    ...
    /**
     * Whether or not to use the front facing camera.
     */
        ...
        private void process(CaptureResult result) {
            switch (mState) {
                ...
                case STATE_WAITING_LOCK: {
                    ...
                    if (afState == null || afState == CaptureResult.CONTROL_AF_MODE_OFF) {
                        captureStillPicture();
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT && !mUseFrontFacing) {
                    continue;
                } else if (facing != null && facing == CameraCharacteristics.LENS_FACING_BACK && mUseFrontFacing) {
                    continue;
                }
