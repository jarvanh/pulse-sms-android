...
public class NoLimitMessageListActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActivityUtils.INSTANCE.setStatusBarColor(this, conversation.getColors().getColorDark());
        ActivityUtils.INSTANCE.setTaskDescription(this, conversation.getTitle(), conversation.getColors().getColor());
    }
